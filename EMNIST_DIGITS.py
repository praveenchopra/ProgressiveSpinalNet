...
"""
This Script contains the ProgressiveSpinalNet  for EMNIST code based on Spinal net code by @author: Dipu from https://github.com/dipuk0506/SpinalNet.
"""
# Importing Libraries
import torch
import torchvision
...
# Snipet fot train and test data
...
Half_width = 256               # output of convolution layer
...
for epoch in range(num_epochs):
    ...
    with torch.no_grad():
        ...
        if best_accuracy>= correct2 / total2:
            curr_lr = learning_rate*np.asscalar(pow(np.random.rand(1),3))
            update_lr(optimizer, curr_lr)
            print('Test Accuracy of SpinalNet: {} % Best: {} %'.format(100 * correct2 / total2, 100*best_accuracy))
        else:
            best_accuracy = correct2 / total2
            net_opt2 = model
